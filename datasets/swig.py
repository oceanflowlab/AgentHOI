...
SWIG_ROOT = os.getenv("SWIG_IMAGE_DIR", "data/swig/images")
SWIG_TRAIN_ANNO = "data/swig_hoi/annotations/swig_trainval_1000.json"
SWIG_VAL_ANNO = "data/swig/swig_test_1000.json"
SWIG_TEST_ANNO = "data/swig/swig_test_1000.json"
