# -*- coding: utf-8 -*-
"""
This file hard-codes metadata for HICO-DET datasets. This will includes:
...
The metadata can be used to run demos without having to download the datasets annotations.
"""
...
# All 117 actions in HICO-DET datasets, together with their prior distributions
...
# All 600 human-object interactions in HICO-DET datasets.
HICO_INTERACTIONS = [
