...
image_base_dir = os.getenv("HICO_IMAGE_DIR", "data/hico_20160224_det/images/test2015")
...
base_dir = os.getenv("HICO_OUTPUT_DIR", f"hico_pipe/output/{model_name}")
...
def initial_HOI_Identification_arguments():
    ...
    parser.add_argument("--image_base_dir", type=str, default=image_base_dir, 
                        help="图片存储的基础目录。")
    parser.add_argument("--annotation_file", type=str, default="data/hico/test_ann_clarification.json", 
                        help="列出图片文件名的注解JSON文件路径。")
    parser.add_argument("--prompt_file", type=str, default="hico_pipe/prompt/Initial_HOI_Identification_prompt.txt", 
                        help="包含系统任务提示的文件路径。")
...
def structured_answer_arguments():
    ...
    parser.add_argument("--failed_file", type=str, default="hico_pipe/output/p1/failed_p2.json",
                        help="包含系统任务提示的文件路径。")
...
def HOI_Remining_arguments():
    ...
    parser.add_argument('--prompt_file', type=str, default='hico_pipe/prompt/HOI_Remining_prompt.txt',
                        help='包含系统任务提示的文件路径。')
...
def Action_Reassignment_arguments():
    ...
    parser.add_argument('--prompt_file', type=str, default='hico_pipe/prompt/Action_Reassignment_prompt.txt', # 源脚本默认值
                        help='包含系统任务提示的文件路径。')
    parser.add_argument('--image_base_dir', type=str,
